<?php
    ...
    if(isset($_POST['enviar'])){
        ...
        $sql = "UPDATE stock SET CantActual=$CantNueva WHERE IdVariedad=$variedad";
        $resultado = mysqli_query($con, $sql);
...
<head>
    ...
    <title>Sisgran - Devolver productos feria</title>
</head>
<body>
    <div class="grid">
        ...
        <main class="grid__main">
            <h1>Devolver productos feria</h1>
            <form action="devolverFeria.php" method="POST" class="feria">
                <div>
                ...
                <div>
                    <input type="submit" value="Devolver" name="enviar" class="boton">
