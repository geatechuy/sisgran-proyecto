    ...
    <title>Sisgran - Modificar informatico</title>
...
<?php
    ...
    if(isset($_POST['enviar'])){
        ...
        if($resultado==true){
            header("location: ../informatico.php#informaticos");
        }
    ...
    while($fila = mysqli_fetch_assoc($resultado)){?>
        <form action="informaticos.php?id=<?php echo $id ?>" method="POST" class="agregar-usuario">
            <h1>Modificar informatico/a: <?php echo $fila['nombre'] . " " . $fila['apellido'] ?></h1>
            <fieldset>
                <label>Id:</label>
            ...
            <div>
                ...
                <a href="../informatico.php#informaticos" name="cancelar" class="boton">Cancelar</a>
            </div>
        </form>
    <?php } ?>