    ...
    <title>Sisgran - Modificar director</title>
...
<?php
    ...
    while($fila = mysqli_fetch_assoc($resultado)){?>
        <form action="directores.php?id=<?php echo $id ?>" method="POST" class="agregar-usuario">
            <h1>Modificar director/ora: <?php echo $fila['nombre'] . " " . $fila['apellido'] ?></h1>
            <fieldset>
                <label>Id:</label>
