...
if(isset($_POST['agregar'])){
    ...
    $sql = "INSERT INTO usuarios (nombre, apellido, Correo, contraseña, id_cargo, Estado) VALUES ('$nombre', '$apellido', '$correo', '$contraseña', 3, 2)";
...
<head>
    ...
    <title>Sisgran - Agregar administradores</title>
</head>
<body>
    <div class="grid">
        <header class="grid__header">
            ...
            <p class="nombre-usuario">Agregar administradores</p>
            <a href="../../../includes/cerrar-sesion.php" class="boton cerrar-sesion-boton">Cerrar sesión</a>
        </header>
        <main class="grid__main">
            <form action="administradores.php" class="agregar-form" method="POST">
                <fieldset>
