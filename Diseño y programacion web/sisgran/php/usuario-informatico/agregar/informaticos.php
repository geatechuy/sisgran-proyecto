...
if(isset($_POST['agregar'])){
    ...
    $sql = "INSERT INTO usuarios (nombre, apellido, Correo, contraseña, id_cargo, Estado) VALUES ('$nombre', '$apellido', '$correo', '$contraseña', 1, 2)";
...
<head>
    ...
    <title>Sisgran - Agregar informáticos</title>
</head>
<body>
    <div class="grid">
        <header class="grid__header">
            ...
            <p class="nombre-usuario">Agregar informáticos</p>
            <a href="../../../includes/cerrar-sesion.php" class="boton cerrar-sesion-boton">Cerrar sesión</a>
        </header>
        <main class="grid__main">
            <form action="informaticos.php" class="agregar-form" method="POST">
                <fieldset>
