    ...
    <title>Sisgran - Borrar informatico</title>
...
<?php
    ...
    <div class="borrar-usuario">
        <h1>Desea borrar al informatico/a: <?php echo $fila['nombre'] . " " . $fila['apellido'] ?></h1>
        ...
        <form action="informaticos.php?id=<?php echo $id ?>" method="POST">
