    ...
    <title>Sisgran - Borrar administrador</title>
...
<?php
    ...
    <div class="borrar-usuario">
        <h1>Desea borrar al administrador/ora: <?php echo $fila['nombre'] . " " . $fila['apellido'] ?></h1>
        ...
        <form action="administradores.php?id=<?php echo $id ?>" method="POST">
