...
<form action="ruta.php" method="POST" class="estado-ruta">
    <h2>Está seguro que desea cambiar el estado de este pedido de Armado a Ruta</h2>
    <div>
...
if(isset($_POST['cambiar'])){
    ...
    // Le pongo fecha fin al estado de armado
    ...
    // Inserto la misma orden con estado ruta y fecha fin null
    $sqlInsert = "INSERT INTO esta (NroOrden, FechaIni, IdEstado) VALUES ('$orden', '$fechaActual', '3')";
