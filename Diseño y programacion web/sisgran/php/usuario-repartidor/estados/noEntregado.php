...
<form action="noEntregado.php" method="POST" class="estado-ruta">
    <h2>Está seguro que desea cambiar el estado de este pedido de Ruta a No entregado</h2>
    <div>
...
if(isset($_POST['cambiar'])){
    ...
    // Inserto la misma orden con estado no entregado y fecha fin null
    $sqlInsert = "INSERT INTO esta (NroOrden, FechaIni, IdEstado) VALUES ('$orden', '$fechaActual', '6')";
